   ...
   <div class="content text-center">
     ...
     <div class="price">                     
      ...
      @elseif($products->products_type==2)
          <a href="{{$products->products_url}} swipe-to-top" target="_blank" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="@lang('website.External Link')"><i class="fa fa-shopping-bag"></i>@lang('website.External Link')</a>
      @endif
