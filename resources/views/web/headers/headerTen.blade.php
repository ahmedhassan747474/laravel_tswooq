                ...
                <div class="search-field-module">   
                  ...
                  <form>
                    <div class="btn-group">
                      ...
                      <select name="category" class="btn btn-secondary swipe-to-top dropdown-toggle header-selection get_brands" style="padding: 0.6rem 1.8rem;">
                        <option value="" style="background-color: #EEE;color: #000;" selected>@lang("website.Choose Any Category")</option>
                        @php    productCategories(); @endphp
                      </select>
                    </div>
                    <div class="btn-group">
                      {{-- <button class="btn btn-secondary swipe-to-top dropdown-toggle header-selection" type="button" id="headerTwoCartButton"  
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" 
                        data-toggle="tooltip" data-placement="bottom" title="@lang("website.Choose Any Brand")"> 
                        @lang("website.Choose Any Brand")
                      </button> 
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="headerTwoCartButton">   
                          @php    productBrands(); @endphp                                                                 
                      </div> --}}
                      <select name="brand" class="btn btn-secondary swipe-to-top dropdown-toggle header-selection set_brands" style="padding: 0.6rem 1.8rem;">
                        <option value="" style="background-color: #EEE;color: #000;" selected>@lang("website.Choose Any Brand")</option>
                        @php    productBrands(); @endphp
                      </select>
                    </div>
                    <div class="btn-group">
                      {{-- <button class="btn btn-secondary swipe-to-top dropdown-toggle header-selection" type="button" id="headerThreeCartButton"  
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" 
                        data-toggle="tooltip" data-placement="bottom" title="@lang("website.Choose Any Price")"> 
                        @lang("website.Choose Any Price")
                      </button> 
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="headerThreeCartButton">   
                          @php    productPrices(); @endphp                                                                 
                      </div> --}}
                      <select name="price" class="btn btn-secondary swipe-to-top dropdown-toggle header-selection" style="padding: 0.6rem 1.8rem;">
                        <option value="" style="background-color: #EEE;color: #000;" selected>@lang("website.Choose Any Price")</option>
                        @php    productPrices(); @endphp
                      </select>
                    </div>

                    <div class="search-field-wrap" style="width: calc(50% - 200px);">
                      <input  type="search" name="search" placeholder="@lang('website.Search entire store here')..." data-toggle="tooltip" data-placement="bottom" title="@lang('website.Search Products')" value="{{ app('request')->input('search') }}" style="padding: 0px;">
                      <button class="btn btn-secondary swipe-to-top" type="submit" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Search Products')">
        ...
        <!--<div class="container">-->
          <nav id="menu-container" class="arrow" style="background-color: #483A6F;">
            ...
            <div class="menu-inner-box">
                <div class="menu">
                  @php    productCategoriesNav(); @endphp
                </div>
            </div>        
          </nav>
        <!--</div>-->
