                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        <!-- form start -->
                                        <div class="box-body">
                                            {!! Form::open(array('url' =>'admin/shippingmethods/updatesmsaexpress', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id',  $result['smsaexpress'][0]->id, array('class'=>'form-control', 'id'=>'id'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('smsaexpress',  $result['smsaexpress'][0]->smsaexpress, array('class'=>'form-control', 'id'=>'smsaexpress'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('currency',  $result['smsaexpress'][0]->currency, array('class'=>'form-control', 'id'=>'currency'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
