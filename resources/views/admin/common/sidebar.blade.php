<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview {{ Request::is('admin/expenses/display') ? 'active' : '' }}  {{ Request::is('admin/expenses/add') ? 'active' : '' }}  {{ Request::is('admin/expenses/edit/*') ? 'active' : '' }} {{ Request::is('admin/expenses/address/display/*') ? 'active' : '' }} {{ Request::is('admin/expenses/filter') ? 'active' : '' }} ">
                <a href="{{ URL::to('admin/expenses/display')}}">
                    <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_expenses') }}</span>
                </a>
            </li>
            ...
            <li class="treeview {{ Request::is('admin/shopsalesreport') ? 'active' : '' }}{{ Request::is('admin/shopemployereport') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ Request::is('admin/shops') ? 'active' : '' }}"><a
                                href="{{ URL::to('admin/shops')}}"><i
                                    class="fa fa-circle-o"></i> {{ trans('labels.shops') }}</a></li>
                    <li class="{{ Request::is('admin/shopsalesreport') ? 'active' : '' }}"><a
                                href="{{ URL::to('admin/shopsalesreport')}}"><i
                                    class="fa fa-circle-o"></i> {{ trans('labels.Sales Report') }}</a></li>
                    <li class="{{ Request::is('admin/shopemployereport') ? 'active' : '' }}"><a
                                href="{{ URL::to('admin/shopemployereport')}}"><i
                                    class="fa fa-circle-o"></i> {{ trans('labels.Employee') }}</a></li>
                </ul>
            </li>
            ...
            <li class="treeview {{ Request::is('admin/reviews/display') ? 'active' : '' }} {{ Request::is('admin/manufacturers/display') ? 'active' : '' }} {{ Request::is('admin/manufacturers/add') ? 'active' : '' }} {{ Request::is('admin/manufacturers/edit/*') ? 'active' : '' }} {{ Request::is('admin/units') ? 'active' : '' }} {{ Request::is('admin/addunit') ? 'active' : '' }} {{ Request::is('admin/editunit/*') ? 'active' : '' }} {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/display') ? 'active' : '' }}  {{ Request::is('admin/products/attributes/add') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} {{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }} {{ Request::is('admin/brands/display') ? 'active' : '' }} {{ Request::is('admin/brands/add') ? 'active' : '' }} {{ Request::is('admin/brands/edit/*') ? 'active' : '' }} {{ Request::is('admin/brands/filter') ? 'active' : '' }} {{ Request::is('admin/products/inventory/display') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->brands_view == 1)
                        <li class="{{ Request::is('admin/brands/display') ? 'active' : '' }} {{ Request::is('admin/brands/add') ? 'active' : '' }} {{ Request::is('admin/brands/edit/*') ? 'active' : '' }} {{ Request::is('admin/brands/filter') ? 'active' : '' }}">
                            <a href="{{ URL::to('admin/brands/display')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_brands') }}</a></li>
                    @endif
                    ...
                    @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view == 1)
                        ...
                        {{-- <li class="{{ Request::is('admin/products/supplier/display') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/supplier/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.supplier') }}</a></li> --}}
                    @endif
                        <?php
                    ...
                    <li class="{{ Request::is('admin/reviews/display') ? 'active' : '' }}">
                        <a href="{{ URL::to('admin/reviews/display')}}">
                            ...
                            <span>{{ trans('labels.reviews') }}</span>@if($result['commonContent']['new_reviews']>0)
                                <span class="label label-success pull-right">{{$result['commonContent']['new_reviews']}} {{ trans('labels.new') }}</span>
                            @endif
                        </a>
                    </li>
                    <?php } ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ Request::is('admin/orders_likecard/display') ? 'active' : '' }} {{ Request::is('admin/orders_likecard/vieworder/*') ? 'active' : '' }}">
                        <a href="{{ URL::to('admin/orders_likecard/display')}}">
                            <i class="fa fa-circle-o" aria-hidden="true"></i>
                            <span> {{ trans('labels.link_orders_likecard') }}</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ Request::is('admin/maxstock') ? 'active' : '' }} {{ Request::is('admin/minstock') ? 'active' : '' }} {{ Request::is('admin/inventoryreport') ? 'active' : '' }} {{ Request::is('admin/salesreport') ? 'active' : '' }} {{ Request::is('admin/couponreport') ? 'active' : '' }} {{ Request::is('admin/customers-orders-report') ? 'active' : '' }} {{ Request::is('admin/outofstock') ? 'active' : '' }} {{ Request::is('admin/statsproductspurchased') ? 'active' : '' }} {{ Request::is('admin/statsproductsliked') ? 'active' : '' }} {{ Request::is('admin/lowinstock') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    @if ($result['commonContent']['roles']->reports_view == 1)
                        ...
                        <li class="{{ Request::is('admin/products-report') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/products-report')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.link_all_products') }}</a></li>
                        <li class="{{ Request::is('admin/products-barcode') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/products-barcode')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.barcode') }}</a></li>
                        <li class="{{ Request::is('admin/inventoryreport') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/inventoryreport')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Inventory Report') }}</a></li>
                        <li class="{{ Request::is('admin/orders_likecard/display') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/orders_likecard/display')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.LikeCard Report') }}</a></li>
                        <li class="{{ Request::is('admin/orders_likecard/balance') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/orders_likecard/balance')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.LikeCard Balance') }}</a></li>
                    @endif

                    @if ($result['commonContent']['roles']->supplier_view == 1)
                        <li class="{{ Request::is('admin/suppliersmainreport') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/suppliersmainreport')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Suppliers Report') }}</a></li>
                    @endif
                    @if ($result['commonContent']['roles']->reports_view == 1)
            ...
            <li class="{{ Request::is('admin/maxstock') ? 'active' : '' }} "><a href="{{ URL::to('admin/maxstock')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.Max Stock Report') }}</a></li> -->
                        <li class="{{ Request::is('admin/customers-orders-report') ? 'active' : '' }} "><a
                                    href="{{ URL::to('admin/customers-orders-report')}}"><i
                        ...
                        <li class="{{ Request::is('admin/couponreport') ? 'active' : '' }}"><a
                                    href="{{ URL::to('admin/couponreport')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Coupon Report') }}</a></li>
                        <li class="{{ Request::is('admin/salesreport') ? 'active' : '' }}"><a
                                    href="{{ URL::to('admin/salesreport')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Sales Report') }}</a></li>
                        <li class="{{ Request::is('admin/salesreportmobile') ? 'active' : '' }}"><a
                                    href="{{ URL::to('admin/salesreportmobile')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Sales Report') }} - Web</a></li>
                        <li class="{{ Request::is('admin/salesreportpos') ? 'active' : '' }}"><a
                                    href="{{ URL::to('admin/salesreportpos')}}"><i
                                        class="fa fa-circle-o"></i> {{ trans('labels.Sales Report') }} - Pos</a></li>
                    @endif
            ...
            <li class="treeview {{ Request::is('admin/shippingmethods/display') ? 'active' : '' }} {{ Request::is('admin/shippingmethods/upsShipping/display') ? 'active' : '' }} {{ Request::is('admin/shippingmethods/flateRate/display') ? 'active' : '' }}">
                <a href="{{ URL::to('admin/shippingmethods/display')}}"><i class="fa fa-truck" aria-hidden="true"></i>
    ...
    <span>      {{ trans('labels.Blog') }}</span> <i class="fa fa-angle-left pull-right"></i>
            ...
            <li class="treeview {{ Request::is('admin/loginsetting') ? 'active' : '' }} {{ Request::is('admin/firebase') ? 'active' : '' }} {{ Request::is('admin/facebooksettings') ? 'active' : '' }} {{ Request::is('admin/setting') ? 'active' : '' }} {{ Request::is('admin/googlesettings') ? 'active' : '' }}  {{ Request::is('admin/alertsetting') ? 'active' : '' }}  ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ Request::is('admin/firebase') ? 'active' : '' }}"><a
                                href="{{ URL::to('admin/firebase')}}"><i
                                    class="fa fa-circle-o"></i> {{ trans('labels.Firebase') }}</a></li>
            ...
            <li class="treeview {{ Request::is('admin/webPagesSettings/12') ? 'active' : '' }} {{ Request::is('admin/instafeed') ? 'active' : '' }} {{ Request::is('admin/menus') ? 'active' : '' }} {{ Request::is('admin/mailchimp') ? 'active' : '' }} {{ Request::is('admin/topoffer/display') ? 'active' : '' }} {{ Request::is('admin/webPagesSettings/*') ? 'active' : '' }} {{ Request::is('admin/homebanners') ? 'active' : '' }} {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} {{ Request::is('admin/webpages') ? 'active' : '' }}  {{ Request::is('admin/addwebpage') ? 'active' : '' }}  {{ Request::is('admin/editwebpage/*') ? 'active' : '' }} {{ Request::is('admin/websettings') ? 'active' : '' }} {{ Request::is('admin/webthemes') ? 'active' : '' }} {{ Request::is('admin/customstyle') ? 'active' : '' }} {{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} ">
                        <a href="{{ URL::to('admin/sliders')}}"><i
                                    class="fa fa-circle-o"></i> {{ trans('labels.link_Sliders') }}</a></li>
