...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Brands') }} <small>{{ trans('labels.AddBrands') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li><a href="{{ URL::to('admin/brands/display')}}"><i class="fa fa-database"></i>{{ trans('labels.Brands') }}</a></li>
            <li class="active">{{ trans('labels.AddBrands') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.AddBrands') }} </h3>
                    </div>
