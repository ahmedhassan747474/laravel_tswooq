...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Brands') }} <small>{{ trans('labels.ListingAllMainBrands') }}...</small> </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="col-lg-6 form-inline">
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/brands/filter')}}">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        @if(isset($param,$name))  <a class="btn btn-danger " href="{{url('admin/brands/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                                <div class="col-lg-4 form-inline" id="contact-form12"></div>
                            </div>
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/brands/add')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewCategory') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if(count($categories)>0)
                                            ...
                                            @foreach ($categories as $key=>$category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{url('admin/brands/edit/'. $category->id) }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/brands/delete', 'name'=>'deleteBanner', 'id'=>'deleteBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
