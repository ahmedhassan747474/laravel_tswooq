...
class BrandsController extends Controller
{
  ...
  public function display(){
    ...
    $categories = $this->Categories->brandPaginator();
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.brands.index",$title)->with('categories', $categories)->with('result', $result);
  }


  public function filter(Request $request){
    $title = array('pageTitle' => Lang::get("labels.SubCategories"));
    $categories = $this->Categories->brandFilter($request);
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.brands.index", $title)
      ->with('result', $result)
      ->with(['categories'=> $categories, 'name'=> $request->FilterBy, 'param'=> $request->parameter]);
  }
  ...
  public function add(Request $request){
    ...
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.brands.add",$title)->with('result', $result)->with('allimage', $allimage);
  }
  ...
  public function insert(Request $request){
        ...
        $message = Lang::get("labels.AddBrandMessage");
  ...
  public function update(Request $request){
    ...
    $message = Lang::get("labels.BrandsUpdateMessage");
    return redirect()->back()->withErrors([$message]);
  }

  public function delete(Request $request){
    $deletecategory = $this->Categories->deleterecord($request);
    $message = Lang::get("labels.BrandsDeleteMessage");
    return redirect()->back()->withErrors([$message]);
  }
}
