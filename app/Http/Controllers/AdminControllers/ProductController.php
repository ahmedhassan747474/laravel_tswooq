...
class ProductController extends Controller
{
    ...
    public function sku_combination(Request $request)
    {
        ...
        return view('admin.products.sku_combinations', compact('combinations', 'unit_price', 'colors_active', 'product_name'));
    }

    public function sku_combination_edit(Request $request)
    {
        $product = AppProduct::where('products_id',$request->id)->first();
        ...
        $product_name = $request->name ?? 'name';
        $unit_price = $request->unit_price;
        ...
        return view('admin.products.sku_combinations_edit', compact('combinations', 'unit_price', 'colors_active', 'product_name', 'product'));
    }
