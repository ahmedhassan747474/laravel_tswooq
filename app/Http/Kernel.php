...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
      ...
      'user' => \App\Http\Middleware\User::class,
        ...
        'view_brands' => \App\Http\Middleware\brands\view_brands::class,
        'edit_brands' => \App\Http\Middleware\brands\edit_brands::class,
        'delete_brands' => \App\Http\Middleware\brands\delete_brands::class,
        'add_brands' => \App\Http\Middleware\brands\add_brands::class,
