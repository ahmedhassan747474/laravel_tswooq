...
Route::group(['middleware' => ['installer', 'back_language']], function () {
    ...
    Route::group(['prefix' => 'admin/brands', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/display', 'BrandsController@display')->middleware('view_brands');
        Route::get('/add', 'BrandsController@add')->middleware('add_brands');;
        Route::post('/add', 'BrandsController@insert')->middleware('add_brands');
        Route::get('/edit/{id}', 'BrandsController@edit')->middleware('edit_brands');
        Route::post('/update', 'BrandsController@update')->middleware('edit_brands');
        Route::post('/delete', 'BrandsController@delete')->middleware('delete_brands');
        Route::get('/filter', 'BrandsController@filter')->middleware('view_brands');
    });
